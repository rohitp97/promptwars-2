    ...
    <div className="pb-24 px-5 pt-8 max-w-md mx-auto min-h-[calc(100vh-130px)]">
      ...
      {step === 1 && (
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          <div className="grid grid-cols-2 gap-4 mt-6">
            {['Yes', 'No'].map(o => (
              <button 
                key={o} onClick={() => { setAnswers({...answers, q1: o}); handleNext(); }}
        ...
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          <div className="flex flex-col gap-3 mt-6">
            {['Yes', 'No', 'Not Sure'].map(o => (
              <button 
                key={o} onClick={() => { setAnswers({...answers, q4: o}); handleNext(); }}
      ...
      {step === 5 && (
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          <div className="grid grid-cols-2 gap-4 mt-6">
            {['Yes', 'No'].map(o => (
              <button 
                key={o} onClick={() => { setAnswers({...answers, q5: o}); handleNext(); }}
      ...
      {step === 6 && (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
          <div className="p-6 rounded-2xl bg-surface border border-gray-200 text-center shadow-lg shadow-black/5 mt-2">
            {isEligible ? (
              <>
          ...
          <RightsCard />
          <button 
            onClick={() => { setStep(1); setAnswers({}); setDob(''); }}
